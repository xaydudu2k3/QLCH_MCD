...
<div class="content bg-gradient-warning py-3 px-4">
    <h3 class="font-weight-bolder text-light">Order</h3>
</div>
                        ...
                        <div id="menu-list">
                            <fieldset>
                                ...
                                <div id="cat-list" class="py-1">
                                    ...
                                    ?>
                                    <button class="btn btn-default btn-xs rounded-pill px-2 cat_btn mx-3 col-lg-3 col-md-4 col-sm-6 col-xs-10 <?= isset($cid) && $cid == $row['id'] ? "bg-gradient-warning text-light" : "bg-gradient-light border" ?>" type="button" data-id='<?= $row['id'] ?>'><?=  $row['name'] ?></button>
                                    <?php endwhile; ?>
                                </div>
                            </fieldset>
                            <fieldset>
                                ...
                                <div id="item-list" class="py-1 overflow-auto">
                                    ...
                                    <div class="col <?= isset($cid) && $cid == $row['category_id'] ? "" : "d-none" ?> menu-item" data-cat-id='<?= $row['category_id'] ?>'>
                                        <button class="btn btn-default btn-block btn-xs rounded-pill px-2 bg-gradient-light border my item-btn" type="button" data-id='<?= $row['id'] ?>' data-price='<?= $row['price'] ?>'><p class="m-0 truncate-1"><?= $row['code'] . " - " . $row['name'] ?></p></button>
                                    </div>
                                    <?php endwhile; ?>
                                    </div>
                                </div>
...
<div class="d-flex w-100 bg-gradient-light product-item">
    ...
    <div class="col-6 font-weight-bolder m-0 border align-middle">
        ...
        <div class="w-100 d-flex aling-items-center"><a href="javascript:void(0)" class="text-danger text-decoration-none rem-item mr-1"><i class="fa fa-times"></i></a> <p class="m-0 truncate-1 menu_name">Menu name</p></div>
